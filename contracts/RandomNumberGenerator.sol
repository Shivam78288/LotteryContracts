...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    **/
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == yodaLottery, "Only YodaLottery");
     ...
     * @param _yodaLottery: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _yodaLottery) external onlyOwner {
        yodaLottery = _yodaLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IYodaLottery(yodaLottery).viewCurrentLotteryId();
    }
}